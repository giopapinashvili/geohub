...
- Added `terms.html`, `privacy.html`, and `storage.rules`.
...
4. Restrict Firebase API key to production domains.
5. Add Cloud Functions for real GeoPoints earning before public launch.
