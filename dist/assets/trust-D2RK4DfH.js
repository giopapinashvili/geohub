import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               *//* empty css               *//* empty css                               *//* empty css                   *//* empty css                          *//* empty css                         */import"./firebase-config-CGKVrgHh.js";import"./gh-admin-bridge-h-7zgsq_.js";import"./config-DSeD8I2H.js";import"./api-client-DV25UnBD.js";import"./main-DZ7-Y9ov.js";import"./account-Dl1_viTm.js";import"./mobile-nav-CEPM5beY.js";import"./chat-popup-BHzNMiBZ.js";import"./geohub-production-stabilization-v1-kYTMrx4r.js";import"./responsive-polish-Cni6BeF_.js";import"./analytics-DyGaP85h.js";import"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/10.14.1/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.14.1/firebase-functions.js";import"https://www.gstatic.com/firebasejs/10.14.1/firebase-analytics.js";import"https://www.gstatic.com/firebasejs/10.14.1/firebase-messaging.js";(function(){var a=null;try{a=window.GeoAuth&&window.GeoAuth.getCurrentUser&&window.GeoAuth.getCurrentUser()||window.GeoCurrentUser||null}catch{}var e=a&&a.trustScore?a.trustScore:0;window._MY_TRUST_SCORE=e})();const c={score:window._MY_TRUST_SCORE||0,maxScore:1e3,nextLevelMin:0,nextLevelMax:300,breakdown:[{label:"Real Check-ins",icon:"fas fa-map-marker-alt",color:"var(--ds-accent)",score:0,max:300,desc:"No check-ins yet"},{label:"Review Quality",icon:"fas fa-star",color:"#f59e0b",score:0,max:250,desc:"No reviews yet"},{label:"Camera Proofs",icon:"fas fa-camera",color:"#3b82f6",score:0,max:250,desc:"No camera proofs yet"},{label:"Community Trust",icon:"fas fa-users",color:"#a78bfa",score:0,max:150,desc:"No community votes yet"},{label:"Safety Record",icon:"fas fa-shield-alt",color:"var(--ds-accent)",score:0,max:50,desc:"Clean record"}],badges:[{label:"Email Verified",icon:"fas fa-envelope",color:"#3b82f6"}]},u=[{index:0,name:"Unverified",icon:"fas fa-user",color:"#64748b",range:"0–100",requirements:["Create a GeoHub account"],benefits:["Browse listings","Save to wishlist"],done:!0,current:!1,locked:!1},{index:1,name:"Basic Verified",icon:"fas fa-check-circle",color:"#3b82f6",range:"101–300",requirements:["Verify email address","Add phone number","Complete your profile (80%)"],benefits:["Write reviews","Add check-ins","Message businesses","Join events"],done:!0,current:!1,locked:!1},{index:2,name:"Camera Proof",icon:"fas fa-camera",color:"var(--ds-accent)",range:"301–500",requirements:["5+ camera-verified check-ins","GPS + timestamp embedded","AI image match passed"],benefits:["Camera Proof badge on reviews","Higher review weight in rankings","Creator eligibility"],done:!0,current:!1,locked:!1},{index:3,name:"Trusted Explorer",icon:"fas fa-shield-alt",color:"var(--ds-accent)",range:"501–800",requirements:["30+ real check-ins","10+ quality reviews","3+ camera proofs","No active warnings"],benefits:["Trusted badge on profile","Priority in search results","Full business contact access","Event organizer tools"],done:!1,current:!0,locked:!1},{index:4,name:"Community Trusted",icon:"fas fa-users",color:"#f59e0b",range:"801–950",requirements:["15+ community votes from other members","6+ months active","50+ check-ins","Zero dispute record"],benefits:["Gold trust badge","Content moderation access","Creator sponsorship access","Featured profile slot"],done:!1,current:!1,locked:!0},{index:5,name:"Business Verified",icon:"fas fa-building",color:"#a78bfa",range:"901–1000",requirements:["Business registration document","Physical location GPS-verified","QR partner kit installed","GeoHub team review passed"],benefits:["Business Verified badge","Full analytics dashboard","Priority listing placement","GeoHub API access"],done:!1,current:!1,locked:!0}],l=[{id:"fake_review",label:"Fake Review",icon:"fas fa-star",color:"#f59e0b",desc:"Fabricated, paid or incentivised review"},{id:"fake_checkin",label:"Fake Check-in",icon:"fas fa-map-marker-alt",color:"var(--ds-accent)",desc:"Check-in submitted without physical presence"},{id:"scam_biz",label:"Scam Business",icon:"fas fa-store-slash",color:"#ef4444",desc:"Business that deceives or defrauds customers"},{id:"bad_behavior",label:"Bad Behavior",icon:"fas fa-exclamation-circle",color:"#f97316",desc:"Harassment, hate speech or unsafe conduct"},{id:"unsafe_event",label:"Unsafe Event",icon:"fas fa-calendar-times",color:"#ef4444",desc:"Event with safety risks or misleading info"},{id:"fake_offer",label:"Fake Creator Offer",icon:"fas fa-handshake-slash",color:"#a78bfa",desc:"Fraudulent brand collaboration offer"}],v=[],b=[{icon:"fas fa-camera",color:"#3b82f6",label:"Camera Proof",desc:"Photo taken in-app with GPS + timestamp during visit"},{icon:"fas fa-redo",color:"var(--ds-accent)",label:"Repeat Customer",desc:"Reviewer has visited this place 3+ times"},{icon:"fas fa-shield-alt",color:"#a78bfa",label:"Trusted Reviewer",desc:"Account has Trusted Explorer level or above"},{icon:"fas fa-qrcode",color:"#f59e0b",label:"QR Check-in",desc:"Physically scanned the business QR on location"},{icon:"fas fa-map-marker-alt",color:"var(--ds-accent)",label:"Verified Visit",desc:"GPS coordinates match business location within 50m"},{icon:"fas fa-exclamation-triangle",color:"#ef4444",label:"Suspicious Pattern",desc:"Unusual posting frequency or location mismatch detected"}];let f=null,p=[];function g(a,e){var t;document.querySelectorAll(".trust-tab").forEach(i=>i.classList.remove("active")),document.querySelectorAll(".trust-tab-panel").forEach(i=>i.classList.remove("active")),e&&e.classList.add("active"),(t=document.getElementById("tp-"+a))==null||t.classList.add("active")}function h(){const e=(c.score/c.maxScore*360).toFixed(1),t=document.getElementById("trustRing");t&&(t.style.background=`conic-gradient(var(--ds-accent) 0deg ${e}deg, #0d1525 ${e}deg)`);const i=Math.min(100,Math.round((c.score-c.nextLevelMin)/(c.nextLevelMax-c.nextLevelMin)*100));setTimeout(()=>{const s=document.getElementById("nextLevelBar");s&&(s.style.width=i+"%")},400);const r=document.getElementById("trustBreakdown");r&&(r.innerHTML=c.breakdown.map(s=>{const d=Math.min(100,Math.round(s.score/s.max*100));return`
        <div class="bd-item">
          <div class="bd-header">
        ...
        </div>`}).join(""),setTimeout(()=>document.querySelectorAll(".bd-bar").forEach(s=>{s.style.width=s.dataset.pct+"%"}),400));const o=document.getElementById("trustBadges");o&&(o.innerHTML=c.badges.map(s=>`
    ...
    <div class="rt-card ${f===e.id?"rt-selected":""}" onclick="selectReportType('${e.id}')">
      ...
      </div>`);const e=document.getElementById("safetyFeed");if(e){const t={resolved:["badge-green","Resolved"],under_review:["badge-gold","Under Review"],dismissed:["badge-gray","Dismissed"],pending:["badge-blue","Pending"]},i=[...v,...p.slice(0,4)].sort((r,o)=>o.ts-r.ts).slice(0,10);e.innerHTML=i.map(r=>{const o=l.find(m=>m.id===r.type)||{label:r.type,icon:"fas fa-flag",color:"#64748b"},[n,s]=t[r.status]||["badge-gray",r.status],d=new Date(r.ts).toLocaleDateString([],{month:"short",day:"numeric"});return`
        <div class="sf-item">
          <div class="sf-icon" style="color:${o.color};background:${o.color}15"><i class="${o.icon}"></i></div>
          <div class="sf-info">
            <div class="sf-type">${o.label}</div>
